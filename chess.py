...
class ChessBoard(object):
    ...
    def __create_pieces(self):
        ...
        self.black_pieces["Queen"] = Queen("Black", self.board[0][3].get_position())
        self.black_pieces["King"] = King("Black", self.board[0][4].get_position())
    ...
    def __setup_pieces(self):
        ...
        self.board[0][3].set_piece(self.black_pieces["Queen"])
        self.board[0][4].set_piece(self.black_pieces["King"])
